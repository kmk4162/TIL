...
![image-20220707012904852](C:\Users\김문경\AppData\Roaming\Typora\typora-user-images\image-20220707012904852.png)
...
-   로컬에 있는 0706 폴더를 GitHub에서 test이름으로 원격저장소 생성 후 push
  ...
  ![image-20220706133357303](Lecture/7.6_수업정리.assets/image-20220706133357303.png)

  2. `$ git remote -v`로 원격 저장소 정보 확인

     ![image-20220706134927340](Lecture/7.6_수업정리.assets/image-20220706134927340.png)

  3. `$ git push origin master`로 push 기능

     ![image-20220706135003468](Lecture/7.6_수업정리.assets/image-20220706135003468.png)

  4. 깃허브 들어가서 확인해보면

     ![image-20220706135041135](Lecture/7.6_수업정리.assets/image-20220706135041135.png)
...
-   로컬에 있는 TIL 폴더를 GitHub에서 TIL 이름으로 원격저장소 생성 후 push
  ...
  1. 마찬가지로 진행해줌
     ...
     ![image-20220706135757441](Lecture/7.6_수업정리.assets/image-20220706135757441.png)
...
![image-20220707014646427](C:\Users\김문경\AppData\Roaming\Typora\typora-user-images\image-20220707014646427.png)
...
- 근데 우리가 못 보던 commit 이름이 나옴
  ...
  ![image-20220707020747303](C:\Users\김문경\AppData\Roaming\Typora\typora-user-images\image-20220707020747303.png)

  > 자동으로 작성된 커밋 메시지!!

- ![image-20220707021007909](C:\Users\김문경\AppData\Roaming\Typora\typora-user-images\image-20220707021007909.png)

- 이렇게 가지치기가 됨

- 정리해보면

  ![image-20220707021058335](C:\Users\김문경\AppData\Roaming\Typora\typora-user-images\image-20220707021058335.png)
